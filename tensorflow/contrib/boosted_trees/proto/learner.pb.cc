...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(TreeConstraintsConfig, max_number_of_unique_feature_columns_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _weak_field_map_
  offsetof(LearningRateConfigDefaultTypeInternal, fixed_),
  offsetof(LearningRateConfigDefaultTypeInternal, dropout_),
  offsetof(LearningRateConfigDefaultTypeInternal, line_search_),
  ...
  ~0u,  // no _weak_field_map_
  offsetof(AveragingConfigDefaultTypeInternal, average_last_n_trees_),
  offsetof(AveragingConfigDefaultTypeInternal, average_last_percent_trees_),
  ...
  offsetof(LearnerConfigDefaultTypeInternal, feature_fraction_per_tree_),
  offsetof(LearnerConfigDefaultTypeInternal, feature_fraction_per_level_),
...
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 8, -1, sizeof(TreeConstraintsConfig)},
  { 16, -1, sizeof(LearningRateConfig)},
  { 25, -1, sizeof(LearningRateFixedConfig)},
  { 31, -1, sizeof(LearningRateLineSearchConfig)},
  { 38, -1, sizeof(AveragingConfig)},
  { 46, -1, sizeof(LearningRateDropoutDrivenConfig)},
  { 54, -1, sizeof(LearnerConfig)},
};
...
void TableStruct::InitDefaultsImpl() {
  ...
  _TreeRegularizationConfig_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_TreeRegularizationConfig_default_instance_);_TreeConstraintsConfig_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_TreeConstraintsConfig_default_instance_);_LearningRateConfig_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_LearningRateConfig_default_instance_);_LearningRateFixedConfig_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_LearningRateFixedConfig_default_instance_);_LearningRateLineSearchConfig_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_LearningRateLineSearchConfig_default_instance_);_AveragingConfig_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_AveragingConfig_default_instance_);_LearningRateDropoutDrivenConfig_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_LearningRateDropoutDrivenConfig_default_instance_);_LearnerConfig_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_LearnerConfig_default_instance_);_LearningRateConfig_default_instance_.fixed_ = const_cast< ::tensorflow::boosted_trees::learner::LearningRateFixedConfig*>(
  ...
  _LearnerConfig_default_instance_._instance.get_mutable()->regularization_ = const_cast< ::tensorflow::boosted_trees::learner::TreeRegularizationConfig*>(
      ::tensorflow::boosted_trees::learner::TreeRegularizationConfig::internal_default_instance());
  _LearnerConfig_default_instance_._instance.get_mutable()->constraints_ = const_cast< ::tensorflow::boosted_trees::learner::TreeConstraintsConfig*>(
      ::tensorflow::boosted_trees::learner::TreeConstraintsConfig::internal_default_instance());
  _LearnerConfig_default_instance_._instance.get_mutable()->learning_rate_tuner_ = const_cast< ::tensorflow::boosted_trees::learner::LearningRateConfig*>(
      ::tensorflow::boosted_trees::learner::LearningRateConfig::internal_default_instance());
  _LearnerConfig_default_instance_._instance.get_mutable()->averaging_config_ = const_cast< ::tensorflow::boosted_trees::learner::AveragingConfig*>(
...
// int64 max_number_of_unique_feature_columns = 3;
void TreeConstraintsConfig::clear_max_number_of_unique_feature_columns() {
  max_number_of_unique_feature_columns_ = GOOGLE_LONGLONG(0);
}
::google::protobuf::int64 TreeConstraintsConfig::max_number_of_unique_feature_columns() const {
...
void TreeConstraintsConfig::set_max_number_of_unique_feature_columns(::google::protobuf::int64 value) {
