...
public:
 ::google::protobuf::internal::ExplicitlyConstructed<AdvisorOptionsProto::AdvisorOptionsProto_CheckersEntry>
     _instance;
} _AdvisorOptionsProto_CheckersEntry_default_instance_;
class AdvisorOptionsProto_CheckerOption_OptionsEntryDefaultTypeInternal {
public:
 ::google::protobuf::internal::ExplicitlyConstructed<AdvisorOptionsProto_CheckerOption::AdvisorOptionsProto_CheckerOption_OptionsEntry>
     _instance;
} _AdvisorOptionsProto_CheckerOption_OptionsEntry_default_instance_;
...
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(OptionsProto)},
  { 27, -1, sizeof(AdvisorOptionsProto_CheckerOption)},
  { 33, -1, sizeof(AdvisorOptionsProto)},
};

static ::google::protobuf::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::google::protobuf::Message*>(&_OptionsProto_default_instance_),
  reinterpret_cast<const ::google::protobuf::Message*>(&_AdvisorOptionsProto_CheckersEntry_default_instance_),
  reinterpret_cast<const ::google::protobuf::Message*>(&_AdvisorOptionsProto_CheckerOption_OptionsEntry_default_instance_),
  reinterpret_cast<const ::google::protobuf::Message*>(&_AdvisorOptionsProto_CheckerOption_default_instance_),
  reinterpret_cast<const ::google::protobuf::Message*>(&_AdvisorOptionsProto_default_instance_),
};
...
file_level_metadata[1].reflection = AdvisorOptionsProto::AdvisorOptionsProto_CheckersEntry::CreateReflection(file_level_metadata[1].descriptor, _AdvisorOptionsProto_CheckersEntry_default_instance_._instance.get_mutable());
file_level_metadata[2].reflection = AdvisorOptionsProto_CheckerOption::AdvisorOptionsProto_CheckerOption_OptionsEntry::CreateReflection(file_level_metadata[2].descriptor, _AdvisorOptionsProto_CheckerOption_OptionsEntry_default_instance_._instance.get_mutable());
}
...
void TableStruct::InitDefaultsImpl() {
  ...
  _OptionsProto_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_OptionsProto_default_instance_);_AdvisorOptionsProto_CheckersEntry_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_AdvisorOptionsProto_CheckersEntry_default_instance_);_AdvisorOptionsProto_CheckerOption_OptionsEntry_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_AdvisorOptionsProto_CheckerOption_OptionsEntry_default_instance_);_AdvisorOptionsProto_CheckerOption_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_AdvisorOptionsProto_CheckerOption_default_instance_);_AdvisorOptionsProto_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_AdvisorOptionsProto_default_instance_);_AdvisorOptionsProto_CheckersEntry_default_instance_._instance.get_mutable()->set_default_instance(_AdvisorOptionsProto_CheckersEntry_default_instance_._instance.get_mutable());
  _AdvisorOptionsProto_CheckersEntry_default_instance_._instance.get_mutable()->InitAsDefaultInstance();
  _AdvisorOptionsProto_CheckerOption_OptionsEntry_default_instance_._instance.get_mutable()->set_default_instance(_AdvisorOptionsProto_CheckerOption_OptionsEntry_default_instance_._instance.get_mutable());
  _AdvisorOptionsProto_CheckerOption_OptionsEntry_default_instance_._instance.get_mutable()->InitAsDefaultInstance();
}
...
OptionsProto::OptionsProto()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_tensorflow_2fcore_2fprofiler_2ftfprof_5foptions_2eproto::InitDefaults();
  }
  SharedCtor();
...
#if LANG_CXX11
void OptionsProto::set_output(::std::string&& value) {
...
AdvisorOptionsProto::AdvisorOptionsProto_CheckersEntry::AdvisorOptionsProto_CheckersEntry() {}
AdvisorOptionsProto::AdvisorOptionsProto_CheckersEntry::AdvisorOptionsProto_CheckersEntry(::google::protobuf::Arena* arena) : SuperType(arena) {}
::google::protobuf::Metadata AdvisorOptionsProto::AdvisorOptionsProto_CheckersEntry::GetMetadata() const {
  protobuf_tensorflow_2fcore_2fprofiler_2ftfprof_5foptions_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_tensorflow_2fcore_2fprofiler_2ftfprof_5foptions_2eproto::file_level_metadata[1];
}
void AdvisorOptionsProto::AdvisorOptionsProto_CheckersEntry::MergeFrom(
    const ::google::protobuf::Message& other) {
  ::google::protobuf::Message::MergeFrom(other);
}
void AdvisorOptionsProto::AdvisorOptionsProto_CheckersEntry::MergeFrom(const AdvisorOptionsProto_CheckersEntry& other) {
...
AdvisorOptionsProto_CheckerOption::AdvisorOptionsProto_CheckerOption_OptionsEntry::AdvisorOptionsProto_CheckerOption_OptionsEntry() {}
AdvisorOptionsProto_CheckerOption::AdvisorOptionsProto_CheckerOption_OptionsEntry::AdvisorOptionsProto_CheckerOption_OptionsEntry(::google::protobuf::Arena* arena) : SuperType(arena) {}
::google::protobuf::Metadata AdvisorOptionsProto_CheckerOption::AdvisorOptionsProto_CheckerOption_OptionsEntry::GetMetadata() const {
  protobuf_tensorflow_2fcore_2fprofiler_2ftfprof_5foptions_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_tensorflow_2fcore_2fprofiler_2ftfprof_5foptions_2eproto::file_level_metadata[2];
}
void AdvisorOptionsProto_CheckerOption::AdvisorOptionsProto_CheckerOption_OptionsEntry::MergeFrom(
    const ::google::protobuf::Message& other) {
  ::google::protobuf::Message::MergeFrom(other);
}
void AdvisorOptionsProto_CheckerOption::AdvisorOptionsProto_CheckerOption_OptionsEntry::MergeFrom(const AdvisorOptionsProto_CheckerOption_OptionsEntry& other) {
  MergeFromInternal(other);
}
