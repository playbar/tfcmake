...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ApiDef_Endpoint, deprecation_message_),
  ~0u,  // no _has_bits_
...
void ApiDef_Endpoint::SharedDtor() {
  ...
  deprecation_message_.Destroy(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), arena);
}
...
// string deprecation_message = 2;
void ApiDef_Endpoint::clear_deprecation_message() {
  deprecation_message_.ClearToEmpty(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
}
const ::std::string& ApiDef_Endpoint::deprecation_message() const {
  // @@protoc_insertion_point(field_get:tensorflow.ApiDef.Endpoint.deprecation_message)
  return deprecation_message_.Get();
}
void ApiDef_Endpoint::set_deprecation_message(const ::std::string& value) {
...
#if LANG_CXX11
void ApiDef_Endpoint::set_deprecation_message(::std::string&& value) {
...
#endif
void ApiDef_Endpoint::set_deprecation_message(const char* value) {
  GOOGLE_DCHECK(value != NULL);
...
::std::string* ApiDef_Endpoint::mutable_deprecation_message() {
...
::std::string* ApiDef_Endpoint::release_deprecation_message() {
...
::std::string* ApiDef_Endpoint::unsafe_arena_release_deprecation_message() {
...
void ApiDef_Endpoint::set_allocated_deprecation_message(::std::string* deprecation_message) {
...
void ApiDef_Endpoint::unsafe_arena_set_allocated_deprecation_message(
