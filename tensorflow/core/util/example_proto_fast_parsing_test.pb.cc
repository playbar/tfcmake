...
void TableStruct::InitDefaultsImpl() {
  ...
  _ExampleWithExtras_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_ExampleWithExtras_default_instance_);_ExampleWithExtras_default_instance_._instance.get_mutable()->features_ = const_cast< ::tensorflow::Features*>(
      ::tensorflow::Features::internal_default_instance());
  _ExampleWithExtras_default_instance_._instance.get_mutable()->extra7_ = const_cast< ::tensorflow::Features*>(
      ::tensorflow::Features::internal_default_instance());
}
...
::google::protobuf::uint8* ExampleWithExtras::InternalSerializeWithCachedSizesToArray(
  ...
  if (this->has_extra7()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        1343, *this->extra7_, deterministic, target);
  }
...
#if LANG_CXX11
void ExampleWithExtras::set_extra1(::std::string&& value) {
