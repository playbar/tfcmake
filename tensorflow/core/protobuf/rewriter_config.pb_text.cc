...
void AppendProtoDebugString(
  ...
  if (msg.shape_optimization() != 0) {
    o->AppendEnumName("shape_optimization", ::tensorflow::EnumName_RewriterConfig_Toggle(msg.shape_optimization()));
  }
  if (msg.remapping() != 0) {
    o->AppendEnumName("remapping", ::tensorflow::EnumName_RewriterConfig_Toggle(msg.remapping()));
  }
  if (msg.scoped_allocator_optimization() != 0) {
    o->AppendEnumName("scoped_allocator_optimization", ::tensorflow::EnumName_RewriterConfig_Toggle(msg.scoped_allocator_optimization()));
  }
